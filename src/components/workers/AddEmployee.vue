    ...
    <el-dialog
      ...
      <el-form style="text-align: left" ref="dataForm">
        <el-form-item>
          ...
          <el-form-item label="酒店名称" :label-width="formLabelWidth" prop="abs">
            <el-input type="text" v-model="form.hotelname" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="薪资" :label-width="formLabelWidth" prop="abs">
            <el-input type="text" v-model="form.salary" autocomplete="off"></el-input>
          </el-form-item>
        </el-form-item>
      </el-form>
